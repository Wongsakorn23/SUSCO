...
class TestSuscoSquareStationsEN():
  ...
  def test_suscoSquareStationsEN(self):
    # Test name: Susco Square Stations EN
    ...
    # 5 | click | css=.fa |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".fa").click()
    # 6 | click | linkText=PRODUCTS SERVICE |  | 
    self.driver.find_element(By.LINK_TEXT, "PRODUCTS SERVICE").click()
    # 7 | mouseOver | linkText=PRODUCTS SERVICE |  | 
    element = self.driver.find_element(By.LINK_TEXT, "PRODUCTS SERVICE")
