...
class TestPersonalPolicyEN():
  ...
  def test_personalPolicyEN(self):
    # Test name: Personal Policy EN
    ...
    # 5 | click | css=.fa |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".fa").click()
    # 6 | click | linkText=Personal Data Protection Policy |  | 
    self.driver.find_element(By.LINK_TEXT, "Personal Data Protection Policy").click()
