...
class TestPersonalPolicyTH():
  ...
  def test_personalPolicyTH(self):
    # Test name: Personal Policy TH
    ...
    # 5 | click | css=.fa |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".fa").click()
    # 6 | click | linkText=นโยบายการคุ้มครองข้อมูลส่วนบุคคล |  | 
    self.driver.find_element(By.LINK_TEXT, "นโยบายการคุ้มครองข้อมูลส่วนบุคคล").click()
