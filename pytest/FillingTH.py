...
class TestFillingTH():
  ...
  def test_fillingTH(self):
    # Test name: Filling TH
    ...
    # 8 | click | linkText=หนังสือชี้ชวน |  | 
    self.vars["window_handles"] = self.driver.window_handles
    # 9 | storeWindowHandle | root |  | 
    self.driver.find_element(By.LINK_TEXT, "หนังสือชี้ชวน").click()
    # 10 | selectWindow | handle=${win4936} |  | 
    self.vars["win4936"] = self.wait_for_window(2000)
    # 11 | close |  |  | 
    self.vars["root"] = self.driver.current_window_handle
    # 12 | selectWindow | handle=${root} |  | 
    self.driver.switch_to.window(self.vars["win4936"])
    self.driver.close()
