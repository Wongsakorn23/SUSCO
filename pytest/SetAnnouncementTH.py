...
class TestSetAnnouncementTH():
  ...
  def test_setAnnouncementTH(self):
    # Test name: Set Announcement TH
    ...
    # 7 | mouseOver | linkText=ข่าวสารบริษัท |  | 
    element = self.driver.find_element(By.LINK_TEXT, "ข่าวสารบริษัท")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    # 8 | click | linkText=ข่าวแจ้งตลาดหลักทรัพย์ |  | 
